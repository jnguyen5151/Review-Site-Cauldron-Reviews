...
builder.Services.AddCors(options =>
{
    options.AddPolicy("AllowAngular",
        policy => policy
            ...
            "https://aboveground-nonreliably-elvis.ngrok-free.dev", 
            "https://cauldronreviewsfrontend-dtcfc7g4fpgqcqd8.centralus-01.azurewebsites.net", 
            "https://thecauldron.xyz",
            "https://www.thecauldron.xyz")
            .AllowAnyHeader()
            .AllowAnyMethod());
});
